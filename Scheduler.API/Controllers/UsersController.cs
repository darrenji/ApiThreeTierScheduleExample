...
namespace Scheduler.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Get()
        {
            ...
            Response.AddPagination(page, pageSize, totalUsersCount, totalPages);
        ...
        {
            User _user = _userRepository.GetSingle(t => t.Id == id, t => t.SchedulesCreated);
            if(_user!=null)
            {
        ...
        {
            IEnumerable<Schedule> _userSchedules = _scheduleRepository.FindBy(t => t.CreatorId == id);
        ...
        public IActionResult Delete(int id)
        {
            ...
            {
                //外联表
                IEnumerable<Attendee> _attendees = _attendeeRepository.FindBy(t => t.UserId == id);
                IEnumerable<Schedule> _schedules = _scheduleRepository.FindBy(t => t.CreatorId == id);
                ...
                {
                    _attendeeRepository.DeleteWhere(t => t.ScheduleId == schedule.Id);
